...
public class ScorecardScrapingServiceTest {
    ...
    public void shouldParseBattingInningsDataFromSomersetVsHampshire() throws Exception {
        ...
        assertThat(kohlerInnings.getOrder()).isEqualTo(1); // Tom Kohler-Cadmore has battingPosition: 1 in JSON
        ...
        assertThat(orrInnings.getOrder()).isEqualTo(1); // Ali Orr has battingPosition: 1 in JSON
    }
    ...
    public void shouldParseBowlingInningsDataFromDurhamVsWorcestershire() throws Exception {
        ...
        assertThat(innings.getOrder()).isEqualTo(1); // Ben Raine has position: 1 in JSON
    }
